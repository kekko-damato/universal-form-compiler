...
// Returned as HTML strings so views can drop them into innerHTML.
// Keeping these inline avoids any extra network/file dependency at runtime.
...
const ICONS = {
  ...
  sparkles:
    '<path d="M9.5 3 11 7l4 1.5-4 1.5L9.5 14 8 10l-4-1.5L8 7l1.5-4Z"/><path d="M19 13.5 19.75 15.5 21.75 16.25 19.75 17 19 19l-.75-2-2-.75 2-.75Z"/><path d="M19 3 19.5 4.5 21 5l-1.5.5L19 7l-.5-1.5L17 5l1.5-.5Z"/>',
...
export function icon(name: IconName, opts: IconOptions = {}): string {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" class="${cls}" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="${sw}" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${ICONS[name]}</svg>`;
}
